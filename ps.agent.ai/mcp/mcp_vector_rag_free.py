...
class MCPVectorRAGFree:
    """
    Free MCP tool using local or free-tier HuggingFace models instead of OpenAI.
    """
    ...
    def _init_llm(self):
        """Use a free HuggingFace chat model"""
        ...
        # 👉 Alternative local LLM (if you have Ollama):
...
if __name__ == "__main__":
    pdf_path = os.path.join(os.getcwd(), "docs", "MasteringInKafka.pdf")
    tool = MCPVectorRAGFree(pdf_path)
    tool.run("Explain Kafka producer delivery guarantees.")
